...
-- Records of sys_menu
-- ----------------------------
-- INSERT INTO `sys_menu` VALUES (1, '用户管理', 0, 1, 'system', '', '', 1, 0, 'M', '0', '0', '', 'ep:avatar', 'admin', '2023-11-22 07:31:26', 'admin', '2024-07-16 14:52:41', '系统管理目录','1');
INSERT INTO `sys_menu` VALUES (2, '数据使用', 0, 3, 'dbquery', '', '', 1, 0, 'M', '0', '0', '', 'ri:menu-search-line', 'admin', '2023-11-22 07:31:26', 'admin', '2024-09-14 11:16:48', '系统监控目录','1');
INSERT INTO `sys_menu` VALUES (3, '安全策略', 0, 4, 'security', '', '', 1, 0, 'M', '0', '0', '', 'ep:key', 'admin', '2023-11-22 07:31:26', 'admin', '2024-06-10 14:47:12', '系统工具目录','1');
-- INSERT INTO `sys_menu` VALUES (100, '人员管理', 1, 1, 'user', 'system/user/index', '', 1, 0, 'M', '0', '0', 'acl:user:list', 'ri:account-circle-line', 'admin', '2023-11-22 07:31:26', 'admin', '2024-06-10 14:22:38', '用户管理菜单','1');
-- INSERT INTO `sys_menu` VALUES (101, '角色管理', 1, 2, 'role', 'system/role/index', '', 1, 0, 'C', '0', '0', 'acl:role:list', 'ri:admin-fill', 'admin', '2023-11-22 07:31:26', '', NULL, '角色管理菜单','1');
-- INSERT INTO `sys_menu` VALUES (102, '菜单管理', 1, 4, 'menu', 'system/menu/index', '', 1, 0, 'M', '0', '0', 'system:menu:list', 'ep:menu', 'admin', '2023-11-22 07:31:26', 'admin', '2024-07-22 15:25:45', '菜单管理菜单','1');
-- INSERT INTO `sys_menu` VALUES (103, '部门管理', 1, 3, 'dept', 'system/dept/index', '', 1, 0, 'M', '0', '0', 'system:dept:list', 'ri:organization-chart', 'admin', '2023-11-22 07:31:26', 'admin', '2024-07-14 23:30:42', '部门管理菜单','1');
INSERT INTO `sys_menu` VALUES (109, '工作台', 2, 1, 'dashboard', 'dbmgt/dashboard/index', '', 1, 0, 'M', '1', '1', '', 'ri:dashboard-line', 'admin', '2023-11-22 07:31:27', 'admin', '2024-07-22 09:28:21', '在线用户菜单','1');
INSERT INTO `sys_menu` VALUES (110, '运维工作台', 2, 2, 'query', 'dbmgt/query/index', '', 1, 0, 'M', '0', '0', '', 'ri:menu-search-line', 'admin', '2023-11-22 07:31:27', 'admin', '2024-09-14 11:17:07', '定时任务菜单','1');
-- INSERT INTO `sys_menu` VALUES (1000, '用户查询', 100, 1, '', '', '', 1, 0, 'F', '0', '0', 'acl:user:query', '#', 'admin', '2023-11-22 07:31:27', '', NULL, '','1');
-- INSERT INTO `sys_menu` VALUES (1001, '用户新增', 100, 2, '', '', '', 1, 0, 'F', '0', '0', 'acl:user:add', '#', 'admin', '2023-11-22 07:31:27', '', NULL, '','1');
-- INSERT INTO `sys_menu` VALUES (1002, '用户修改', 100, 3, '', '', '', 1, 0, 'F', '0', '0', 'acl:user:edit', '#', 'admin', '2023-11-22 07:31:27', '', NULL, '','1');
-- INSERT INTO `sys_menu` VALUES (1003, '用户删除', 100, 4, '', '', '', 1, 0, 'F', '0', '0', 'acl:user:remove', '#', 'admin', '2023-11-22 07:31:27', '', NULL, '','1');
-- INSERT INTO `sys_menu` VALUES (1004, '上传头像', 100, 5, '', '', '', 1, 0, 'F', '0', '0', 'acl:user:avatar', '#', 'admin', '2023-11-22 07:31:27', 'admin', '2024-07-17 10:54:29', '','1');
-- INSERT INTO `sys_menu` VALUES (1005, '分配角色', 100, 7, '', '', '', 1, 0, 'F', '0', '0', 'acl:user:role', '#', 'admin', '2023-11-22 07:31:27', 'admin', '2024-07-17 10:54:36', '','1');
INSERT INTO `sys_menu` VALUES (1006, '重置密码', 100, 6, '', '', '', 1, 0, 'F', '0', '0', 'acl:user:resetpwd', '#', 'admin', '2023-11-22 07:31:27', 'admin', '2024-07-17 10:54:41', '','1');
-- INSERT INTO `sys_menu` VALUES (1007, '角色查询', 101, 1, '', '', '', 1, 0, 'F', '0', '0', 'acl:role:query', '#', 'admin', '2023-11-22 07:31:27', '', NULL, '','1');
-- INSERT INTO `sys_menu` VALUES (1008, '角色新增', 101, 2, '', '', '', 1, 0, 'F', '0', '0', 'acl:role:add', '#', 'admin', '2023-11-22 07:31:27', '', NULL, '','1');
-- INSERT INTO `sys_menu` VALUES (1009, '角色修改', 101, 3, '', '', '', 1, 0, 'F', '0', '0', 'acl:role:edit', '#', 'admin', '2023-11-22 07:31:27', '', NULL, '','1');
-- INSERT INTO `sys_menu` VALUES (1010, '角色删除', 101, 4, '', '', '', 1, 0, 'F', '0', '0', 'acl:role:remove', '#', 'admin', '2023-11-22 07:31:27', '', NULL, '','1');
-- INSERT INTO `sys_menu` VALUES (1011, '分配权限', 101, 5, '', '', '', 1, 0, 'F', '0', '0', 'acl:role:permission', '#', 'admin', '2023-11-22 07:31:27', 'admin', '2024-07-17 10:49:30', '','1');
-- INSERT INTO `sys_menu` VALUES (1012, '菜单查询', 102, 1, '', '', '', 1, 0, 'F', '0', '0', 'system:menu:query', '#', 'admin', '2023-11-22 07:31:27', '', NULL, '','1');
-- INSERT INTO `sys_menu` VALUES (1013, '菜单新增', 102, 2, '', '', '', 1, 0, 'F', '0', '0', 'system:menu:add', '#', 'admin', '2023-11-22 07:31:27', '', NULL, '','1');
-- INSERT INTO `sys_menu` VALUES (1014, '菜单修改', 102, 3, '', '', '', 1, 0, 'F', '0', '0', 'system:menu:edit', '#', 'admin', '2023-11-22 07:31:27', '', NULL, '','1');
-- INSERT INTO `sys_menu` VALUES (1015, '菜单删除', 102, 4, '', '', '', 1, 0, 'F', '0', '0', 'system:menu:remove', '#', 'admin', '2023-11-22 07:31:28', '', NULL, '','1');
-- INSERT INTO `sys_menu` VALUES (1016, '部门查询', 103, 1, '', '', '', 1, 0, 'F', '0', '0', 'system:dept:query', '#', 'admin', '2023-11-22 07:31:28', '', NULL, '','1');
-- INSERT INTO `sys_menu` VALUES (1017, '部门新增', 103, 2, '', '', '', 1, 0, 'F', '0', '0', 'system:dept:add', '#', 'admin', '2023-11-22 07:31:28', '', NULL, '','1');
-- INSERT INTO `sys_menu` VALUES (1018, '部门修改', 103, 3, '', '', '', 1, 0, 'F', '0', '0', 'system:dept:edit', '#', 'admin', '2023-11-22 07:31:28', '', NULL, '','1');
-- INSERT INTO `sys_menu` VALUES (1019, '部门删除', 103, 4, '', '', '', 1, 0, 'F', '0', '0', 'system:dept:remove', '#', 'admin', '2023-11-22 07:31:28', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2000, '资产管理', 0, 2, 'dbmgt', '', NULL, 1, 0, 'M', '0', '0', '', 'ep:coin', 'admin', '2023-12-03 11:17:03', 'admin', '2024-09-14 11:18:09', '','1');
INSERT INTO `sys_menu` VALUES (2001, '数据库资产', 2000, 2, 'db', 'system/db/index', NULL, 1, 0, 'M', '0', '0', 'system:databaseinfo:list', 'ri:database-2-line', 'admin', '2023-12-03 11:19:52', 'admin', '2024-09-14 11:18:36', '','1');
INSERT INTO `sys_menu` VALUES (2002, '数据统计', 2000, 1, 'dashboardstat', 'dbmgt/dashboard/index', NULL, 1, 0, 'M', '1', '1', '', 'ri:pie-chart-2-line', 'admin', '2023-12-03 12:53:14', 'admin', '2024-07-22 09:27:25', '','1');
INSERT INTO `sys_menu` VALUES (2003, '数据库详情', 2000, 3, 'ops', 'dbmgt/ops/index', NULL, 1, 0, 'M', '0', '0', '', 'ri:chat-follow-up-line', 'admin', '2024-06-10 14:40:23', 'admin', '2024-09-14 11:18:44', '','1');
INSERT INTO `sys_menu` VALUES (2004, '凭证管理', 2000, 4, 'credential', 'dbmgt/credential/index', NULL, 1, 0, 'M', '0', '0', '', 'ri:key-2-line', 'admin', '2024-06-10 14:40:59', 'admin', '2024-07-14 23:35:09', '','1');
-- INSERT INTO `sys_menu` VALUES (2005, '资产授权', 2000, 5, 'auth', 'dbmgt/auth/index', NULL, 1, 0, 'M', '0', '0', 'system:group:list', 'ri:function-add-line', 'admin', '2024-06-10 14:41:45', 'admin', '2024-09-14 11:18:52', '','1');
INSERT INTO `sys_menu` VALUES (2006, '安全监控', 3, 1, 'monitorindex', 'security/monitorindex/index', NULL, 1, 0, 'M', '0', '0', 'system:monitorindex:list', 'ep:data-line', 'admin', '2024-06-10 14:48:35', 'admin', '2024-09-29 09:53:14', '','1');
INSERT INTO `sys_menu` VALUES (2007, '安全策略', 3, 2, 'strategy', 'security/security/index', NULL, 1, 0, 'M', '0', '0', 'system:securityconfig:list', 'ri:file-shield-2-line', 'admin', '2024-06-10 14:49:48', 'admin', '2024-08-05 22:01:39', '','1');
INSERT INTO `sys_menu` VALUES (2008, '操作命令', 3, 4, 'command', 'security/command/index', NULL, 1, 0, 'M', '1', '1', '', 'ri:slash-commands', 'admin', '2024-06-10 14:50:47', 'admin', '2024-07-22 09:28:37', '','1');
-- INSERT INTO `sys_menu` VALUES (2009, '脱敏配置', 3, 5, 'datamasking', 'security/datamasking/index', NULL, 1, 0, 'M', '0', '0', 'system:desenconfig:list', 'ri:character-recognition-line', 'admin', '2024-06-10 14:51:29', 'admin', '2024-07-15 15:44:41', '','1');
INSERT INTO `sys_menu` VALUES (2010, '监控策略', 3, 6, 'monitor', 'security/monitor/index', NULL, 1, 0, 'M', '1', '1', '', 'ep:monitor', 'admin', '2024-06-10 14:52:26', 'admin', '2024-07-22 09:28:47', '','1');
INSERT INTO `sys_menu` VALUES (2011, '告警配置', 3, 7, 'alert', 'security/alert/index', NULL, 1, 0, 'M', '1', '1', 'system:warntype:list', 'ri:file-warning-line', 'admin', '2024-06-10 14:53:15', 'admin', '2024-07-22 09:29:37', '','1');
-- INSERT INTO `sys_menu` VALUES (2012, '数据工单', 0, 5, 'workorder', '', NULL, 1, 0, 'M', '0', '0', '', 'ri:list-check', 'admin', '2024-06-10 14:54:13', 'admin', '2024-09-14 11:19:34', '','1');
-- INSERT INTO `sys_menu` VALUES (2013, '工单列表', 2012, 1, 'WorkOrderListPage', 'workorder/list/index', NULL, 1, 0, 'M', '0', '0', 'system:workorder:list', 'ri:list-check', 'admin', '2024-06-10 14:55:02', 'admin', '2024-09-14 11:20:39', '','1');
-- INSERT INTO `sys_menu` VALUES (2014, '工单申请', 2012, 2, 'apply', 'workorder/apply/index', NULL, 1, 0, 'M', '1', '0', '', 'ri:file-list-3-line', 'admin', '2024-06-10 14:55:37', 'admin', '2024-07-25 18:38:12', '','1');
-- INSERT INTO `sys_menu` VALUES (2015, '工单审批', 2012, 3, 'WorkOrderApprovalPage', 'workorder/approval/index', NULL, 1, 0, 'M', '0', '0', 'system:workorder:list', 'ri:pass-valid-line', 'admin', '2024-06-10 14:56:22', 'admin', '2024-07-28 15:55:28', '','1');
INSERT INTO `sys_menu` VALUES (2016, '数据日志', 0, 6, 'datalog', NULL, NULL, 1, 0, 'M', '0', '0', NULL, 'ri:archive-2-fill', 'admin', '2024-06-10 14:57:03', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2017, '系统日志', 2016, 1, 'systemlog', 'datalog/system/index', NULL, 1, 0, 'M', '0', '0', 'usermonitor:userlog:list', 'ri:archive-drawer-fill', 'admin', '2024-06-10 14:57:35', 'admin', '2024-07-15 16:15:36', '','1');
INSERT INTO `sys_menu` VALUES (2019, '数据日志', 2016, 3, 'data', 'datalog/data/index', NULL, 1, 0, 'M', '1', '0', 'data:operlog:list', 'ri:archive-stack-fill', 'admin', '2024-06-10 14:58:59', 'admin', '2024-07-27 18:02:17', '','1');
INSERT INTO `sys_menu` VALUES (2020, '审批日志', 2016, 4, 'approvallog', 'datalog/approvallog/index', NULL, 1, 0, 'M', '1', '0', 'data:worksheetlog:list', 'ri:archive-2-fill', 'admin', '2024-06-10 14:59:31', 'admin', '2024-07-25 16:13:00', '','1');
...
INSERT INTO `sys_menu` VALUES (2022, '系统概况', 2021, 1, 'info', 'setting/info/index', NULL, 1, 0, 'M', '0', '0', '', 'ri:folder-info-line', 'admin', '2024-06-10 15:00:56', 'admin', '2024-07-15 16:22:28', '','1');
...
INSERT INTO `sys_menu` VALUES (2026, '系统升级', 2021, 4, 'upgrade', 'setting/upgrade/index', NULL, 1, 0, 'M', '0', '0', '', 'ri:upload-cloud-2-line', 'admin', '2024-06-10 15:04:52', 'admin', '2024-07-15 16:23:35', '','1');
INSERT INTO `sys_menu` VALUES (2028, '审计策略', 3, 3, 'audit', 'security/audit/index', NULL, 1, 0, 'M', '0', '0', 'system:auditconfig:list', 'ri:user-search-line', 'admin', '2024-06-24 13:18:31', 'admin', '2024-07-15 15:40:48', '','1');
INSERT INTO `sys_menu` VALUES (2029, '资产查询', 2001, 1, '', '', NULL, 1, 0, 'F', '0', '0', 'system:databaseinfo:query', '#', 'admin', '2024-07-14 23:37:48', 'admin', '2024-07-15 09:41:44', '','1');
INSERT INTO `sys_menu` VALUES (2030, '新增数据资产', 2001, 2, '', '', NULL, 1, 0, 'F', '0', '0', 'system:databaseinfo:add', '#', 'admin', '2024-07-14 23:38:17', 'admin', '2024-07-15 14:44:16', '','1');
INSERT INTO `sys_menu` VALUES (2031, '修改数据资产', 2001, 3, '', '', NULL, 1, 0, 'F', '0', '0', 'system:databaseinfo:edit', '#', 'admin', '2024-07-14 23:38:40', 'admin', '2024-07-15 14:44:34', '','1');
INSERT INTO `sys_menu` VALUES (2032, '删除数据资产', 2001, 4, '', '', NULL, 1, 0, 'F', '0', '0', 'system:databaseinfo:remove', '#', 'admin', '2024-07-14 23:38:59', 'admin', '2024-07-15 14:44:44', '','1');
-- INSERT INTO `sys_menu` VALUES (2033, '群组查询', 2005, 1, '', NULL, NULL, 1, 0, 'F', '0', '0', 'system:group:query', '#', 'admin', '2024-07-15 14:38:28', '', NULL, '','1');
-- INSERT INTO `sys_menu` VALUES (2034, '修改群组', 2005, 3, '', '', NULL, 1, 0, 'F', '0', '0', 'system:group:edit', '#', 'admin', '2024-07-15 14:42:44', 'admin', '2024-07-15 14:45:50', '','1');
-- INSERT INTO `sys_menu` VALUES (2035, '新增群组', 2005, 2, '', '', NULL, 1, 0, 'F', '0', '0', 'system:group:add', '#', 'admin', '2024-07-15 14:43:05', 'admin', '2024-07-15 14:43:19', '','1');
-- INSERT INTO `sys_menu` VALUES (2036, '删除群组', 2005, 4, '', NULL, NULL, 1, 0, 'F', '0', '0', 'system:group:remove', '#', 'admin', '2024-07-15 14:46:10', '', NULL, '','1');
-- INSERT INTO `sys_menu` VALUES (2037, '群组授权', 2005, 5, '', '', NULL, 1, 0, 'F', '0', '0', 'system:group:grant', '#', 'admin', '2024-07-15 14:50:20', 'admin', '2024-07-15 15:06:16', '','1');
INSERT INTO `sys_menu` VALUES (2038, '新增', 2006, 2, '', '', NULL, 1, 0, 'F', '0', '0', 'system:monitorindex:add', '#', 'admin', '2024-07-15 15:30:05', 'admin', '2024-07-15 15:31:52', '','1');
INSERT INTO `sys_menu` VALUES (2039, '修改', 2006, 3, '', '', NULL, 1, 0, 'F', '0', '0', 'system:monitorindex:edit', '#', 'admin', '2024-07-15 15:31:08', 'admin', '2024-07-15 15:32:00', '','1');
INSERT INTO `sys_menu` VALUES (2040, '查询', 2006, 1, '', NULL, NULL, 1, 0, 'F', '0', '0', 'system:monitorindex:query', '#', 'admin', '2024-07-15 15:31:45', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2041, '删除', 2006, 4, '', NULL, NULL, 1, 0, 'F', '0', '0', 'system:monitorindex:remove', '#', 'admin', '2024-07-15 15:32:33', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2042, '查询策略', 2007, 1, '', '', NULL, 1, 0, 'F', '0', '0', 'system:securityconfig:query', '#', 'admin', '2024-07-15 15:35:22', 'admin', '2024-07-17 11:20:19', '','1');
INSERT INTO `sys_menu` VALUES (2043, '新增策略', 2007, 2, '', '', NULL, 1, 0, 'F', '0', '0', 'system:securityconfig:add', '#', 'admin', '2024-07-15 15:35:42', 'admin', '2024-07-17 11:19:33', '','1');
INSERT INTO `sys_menu` VALUES (2044, '修改策略', 2007, 3, '', '', NULL, 1, 0, 'F', '0', '0', 'system:securityconfig:edit', '#', 'admin', '2024-07-15 15:36:22', 'admin', '2024-07-17 11:19:41', '','1');
INSERT INTO `sys_menu` VALUES (2045, '删除策略', 2007, 4, '', '', NULL, 1, 0, 'F', '0', '0', 'system:securityconfig:remove', '#', 'admin', '2024-07-15 15:36:42', 'admin', '2024-07-17 11:19:49', '','1');
INSERT INTO `sys_menu` VALUES (2046, '查询策略', 2028, 1, '', '', NULL, 1, 0, 'F', '0', '0', 'system:auditconfig:query', '#', 'admin', '2024-07-15 15:41:08', 'admin', '2024-07-17 11:20:29', '','1');
INSERT INTO `sys_menu` VALUES (2047, '新增策略', 2028, 2, '', '', NULL, 1, 0, 'F', '0', '0', 'system:auditconfig:add', '#', 'admin', '2024-07-15 15:41:30', 'admin', '2024-07-17 11:20:42', '','1');
INSERT INTO `sys_menu` VALUES (2048, '修改策略', 2028, 3, '', '', NULL, 1, 0, 'F', '0', '0', 'system:auditconfig:edit', '#', 'admin', '2024-07-15 15:41:43', 'admin', '2024-07-17 11:20:45', '','1');
INSERT INTO `sys_menu` VALUES (2049, '删除策略', 2028, 4, '', '', NULL, 1, 0, 'F', '0', '0', 'system:auditconfig:remove', '#', 'admin', '2024-07-15 15:41:55', 'admin', '2024-07-17 11:20:49', '','1');
-- INSERT INTO `sys_menu` VALUES (2050, '查询脱敏配置', 2009, 1, '', '', NULL, 1, 0, 'F', '0', '0', 'system:desenconfig:query', '#', 'admin', '2024-07-15 15:45:13', 'admin', '2024-07-17 11:24:38', '','1');
-- INSERT INTO `sys_menu` VALUES (2051, '新增脱敏配置', 2009, 2, '', '', NULL, 1, 0, 'F', '0', '0', 'system:desenconfig:add', '#', 'admin', '2024-07-15 15:45:35', 'admin', '2024-07-17 11:24:47', '','1');
-- INSERT INTO `sys_menu` VALUES (2052, '修改脱敏配置', 2009, 3, '', '', NULL, 1, 0, 'F', '0', '0', 'system:desenconfig:edit', '#', 'admin', '2024-07-15 15:45:53', 'admin', '2024-07-17 11:24:52', '','1');
-- INSERT INTO `sys_menu` VALUES (2053, '删除脱敏配置', 2009, 4, '', '', NULL, 1, 0, 'F', '0', '0', 'system:desenconfig:remove', '#', 'admin', '2024-07-15 15:46:12', 'admin', '2024-07-17 11:24:56', '','1');
-- INSERT INTO `sys_menu` VALUES (2054, '脱敏方式维护', 2009, 5, '', NULL, NULL, 1, 0, 'F', '0', '0', 'system:desentype:list,system:desentype:query', '#', 'admin', '2024-07-15 15:52:19', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2056, '修改告警配置', 2011, 2, '', '', NULL, 1, 0, 'F', '0', '0', 'system:warntype:edit', '#', 'admin', '2024-07-15 16:06:32', 'admin', '2024-07-17 11:34:53', '','1');
INSERT INTO `sys_menu` VALUES (2058, '审计日志', 2016, 5, 'auditlog', 'datalog/auditlog/index', NULL, 1, 0, 'M', '0', '0', 'data:auditlog:list', 'ri:archive-2-fill', 'admin', '2024-07-15 16:11:45', 'admin', '2024-07-17 07:12:11', '','1');
INSERT INTO `sys_menu` VALUES (2059, '连接测试', 2001, 5, '', NULL, NULL, 1, 0, 'F', '1', '0', 'system:databaseinfo:test', '#', 'admin', '2024-07-17 11:00:07', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2060, '禁用数据资产', 2001, 6, '', NULL, NULL, 1, 0, 'F', '1', '0', 'system:databaseinfo:disable', '#', 'admin', '2024-07-17 11:00:38', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2061, 'SNMP设置', 2001, 7, '', NULL, NULL, 1, 0, 'F', '1', '0', 'system:databaseinfo:snmp', '#', 'admin', '2024-07-17 11:00:57', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2062, '设置策略', 2007, 5, '', '', NULL, 1, 0, 'F', '1', '0', 'system:securityconfig:setting', '#', 'admin', '2024-07-17 11:18:32', 'admin', '2024-07-17 11:20:00', '','1');
INSERT INTO `sys_menu` VALUES (2063, '设置策略', 2028, 5, '', '', NULL, 1, 0, 'F', '1', '0', 'system:auditconfig:setting', '#', 'admin', '2024-07-17 11:21:15', 'admin', '2024-07-17 11:21:31', '','1');
INSERT INTO `sys_menu` VALUES (2064, '数据库巡检', 2, 3, 'inspect', 'dbmgt/inspect/index', NULL, 1, 0, 'M', '0', '0', '', 'ep:operation', 'admin', '2024-07-18 08:22:09', 'admin', '2024-09-14 11:17:42', '','1');
INSERT INTO `sys_menu` VALUES (2066, '安全日志', 2016, 6, 'warnlog', 'datalog/warn/index', NULL, 1, 0, 'M', '0', '0', 'system:message:list', 'ep:bell-filled', 'admin', '2024-07-24 13:04:01', 'admin', '2024-07-24 13:05:46', '','1');
INSERT INTO `sys_menu` VALUES (2067, '查看工单', 2013, 2, '', '', NULL, 1, 0, 'F', '0', '0', 'system:workorder:query', '#', 'admin', '2024-07-28 15:54:13', 'admin', '2024-07-28 15:54:47', '','1');
INSERT INTO `sys_menu` VALUES (2068, '新增工单', 2013, 1, '', '', NULL, 1, 0, 'F', '0', '0', 'system:workorder:add,system:databaseinfo:query', '#', 'admin', '2024-07-28 15:55:02', 'admin', '2024-07-28 16:47:06', '','1');
INSERT INTO `sys_menu` VALUES (2069, '查看工单', 2015, 1, '', NULL, NULL, 1, 0, 'F', '0', '0', 'system:workorder:query', '#', 'admin', '2024-07-28 15:56:22', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2070, '审核工单', 2015, 2, '', '', NULL, 1, 0, 'F', '0', '0', 'system:workorder:audit', '#', 'admin', '2024-07-28 15:56:46', 'admin', '2024-09-17 12:21:41', '','1');
INSERT INTO `sys_menu` VALUES (2071, '新建巡检任务', 2064, 1, '', NULL, NULL, 1, 0, 'F', '0', '0', 'system:task:add', '#', 'admin', '2024-07-29 09:00:32', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2072, '修改巡检任务', 2064, 2, '', NULL, NULL, 1, 0, 'F', '0', '0', 'system:task:edit', '#', 'admin', '2024-07-29 09:01:36', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2073, '浏览巡检任务', 2064, 3, '', NULL, NULL, 1, 0, 'F', '0', '0', 'system:task:list', '#', 'admin', '2024-07-29 09:02:19', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2074, '一键巡检', 2064, 4, '', NULL, NULL, 1, 0, 'F', '0', '0', 'system:task:excuete', '#', 'admin', '2024-07-29 09:06:14', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2075, '执行语句', 2003, 1, '', NULL, NULL, 1, 0, 'F', '0', '0', 'system:databaseexcute:verify', '#', 'admin', '2024-07-29 09:14:16', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2076, '内置策略开关', 2007, 6, '', NULL, NULL, 1, 0, 'F', '0', '0', 'system:securityrule:add', '#', 'admin', '2024-08-06 08:50:11', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2077, '资产分组', 2000, 1, 'datagroup', 'system/group/index', NULL, 1, 0, 'M', '0', '0', '', 'ep:folder', 'admin', '2024-08-22 16:19:56', 'admin', '2024-08-22 23:25:11', '','1');
INSERT INTO `sys_menu` VALUES (2078, '资产组查询', 2077, 1, '', NULL, NULL, 1, 0, 'F', '0', '0', 'system:datagroup:query', '#', 'admin', '2024-08-22 16:23:11', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2079, '新增资产组', 2077, 2, '', '', NULL, 1, 0, 'F', '0', '0', 'system:datagroup:add', '#', 'admin', '2024-08-22 16:24:05', 'admin', '2024-08-22 16:24:15', '','1');
INSERT INTO `sys_menu` VALUES (2080, '修改资产组', 2077, 3, '', '', NULL, 1, 0, 'F', '0', '0', 'system:datagroup:edit', '#', 'admin', '2024-08-22 16:24:52', 'admin', '2024-08-22 16:25:01', '','1');
INSERT INTO `sys_menu` VALUES (2081, '删除资产组', 2077, 4, '', NULL, NULL, 1, 0, 'F', '0', '0', 'system:datagroup:remove', '#', 'admin', '2024-08-22 16:26:05', '', NULL, '','1');
-- INSERT INTO `sys_menu` VALUES (2082, '敏感扫描', 3, 8, 'desenscan', 'security/desenscan/index', NULL, 1, 0, 'M', '0', '0', '', 'ep:full-screen', 'admin', '2024-08-23 11:33:51', 'admin', '2024-08-23 11:39:02', '','1');
-- INSERT INTO `sys_menu` VALUES (2083, '浏览扫描任务', 2082, 1, '', '', NULL, 1, 0, 'F', '0', '0', 'security:desenscan:query', '#', 'admin', '2024-08-23 11:35:09', 'admin', '2024-08-23 11:39:27', '','1');
-- INSERT INTO `sys_menu` VALUES (2084, '新建扫描', 2082, 2, '', '', NULL, 1, 0, 'F', '0', '0', 'security:desenscan:add', '#', 'admin', '2024-08-23 11:35:48', 'admin', '2024-08-23 11:39:43', '','1');
-- INSERT INTO `sys_menu` VALUES (2085, '浏览扫描结果', 2082, 3, '', '', NULL, 1, 0, 'F', '0', '0', 'security:desenscan:detail', '#', 'admin', '2024-08-23 11:36:59', 'admin', '2024-08-23 11:39:55', '','1');
-- INSERT INTO `sys_menu` VALUES (2086, '确认扫描结果', 2082, 4, '', '', NULL, 1, 0, 'F', '0', '0', 'security:desenscan:confirm', '#', 'admin', '2024-08-23 11:37:37', 'admin', '2024-08-23 11:40:08', '','1');
-- INSERT INTO `sys_menu` VALUES (2087, '导出扫描结果', 2082, 99, '', NULL, NULL, 1, 0, 'F', '0', '0', 'security:desenscan:export', '#', 'admin', '2024-08-31 14:28:56', '', NULL, '','1');
-- INSERT INTO `sys_menu` VALUES (2088, '执行工单', 2013, 99, '', NULL, NULL, 1, 0, 'F', '0', '0', 'system:workorder:audit', '#', 'admin', '2024-09-14 09:53:31', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2090, '报表管理', 0, 7, 'report', '', NULL, 1, 0, 'M', '0', '0', '', 'ep:document', 'admin', '2024-09-26 11:00:19', 'admin', '2024-09-26 22:04:58', '','1');
INSERT INTO `sys_menu` VALUES (2091, '权限快照', 2090, 1, 'snap', 'report/snap/index', NULL, 1, 0, 'M', '0', '0', 'report:authsnap:list', 'ep:camera', 'admin', '2024-09-26 11:01:46', 'admin', '2024-09-26 22:05:23', '','1');
INSERT INTO `sys_menu` VALUES (2092, '安全报表', 2090, 2, 'config', 'report/config/index', NULL, 1, 0, 'M', '0', '0', 'report:config:list', 'ep:tickets', 'admin', '2024-09-26 11:05:25', 'admin', '2024-09-26 22:06:52', '','1');
INSERT INTO `sys_menu` VALUES (2093, '新建权限快照', 2091, 1, '', '', NULL, 1, 0, 'F', '0', '0', 'report:authsnap:add', '#', 'admin', '2024-09-26 21:59:48', 'admin', '2024-09-26 22:01:03', '','1');
INSERT INTO `sys_menu` VALUES (2094, '下载权限快照', 2091, 2, '', NULL, NULL, 1, 0, 'F', '0', '0', 'report:authsnap:export', '#', 'admin', '2024-09-26 22:00:43', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2095, '新建报表策略', 2092, 1, '', NULL, NULL, 1, 0, 'F', '0', '0', 'report:config:add', '#', 'admin', '2024-09-26 22:02:27', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2096, '修改报表策略', 2092, 2, '', NULL, NULL, 1, 0, 'F', '0', '0', 'report:config:edit', '#', 'admin', '2024-09-26 22:03:07', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2097, '下载报表数据', 2092, 3, '', NULL, NULL, 1, 0, 'F', '0', '0', 'report:config:export', '#', 'admin', '2024-09-26 22:03:41', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2098, '删除报表策略', 2092, 4, '', NULL, NULL, 1, 0, 'F', '0', '0', 'report:config:remove', '#', 'admin', '2024-10-04 09:20:40', '', NULL, '','1');
INSERT INTO `sys_menu` VALUES (2099, '巡检模版', 2, 4, 'template', 'dbmgt/template/index', NULL, 1, 0, 'M', '0', '0', '', 'ri:article-line', 'admin', '2024-10-08 13:39:52', 'admin', '2024-10-08 13:40:03', '','1');
INSERT INTO `sys_menu` VALUES (2100, '新建巡检模版', 2099, 1, '', '', NULL, 1, 0, 'F', '0', '0', 'system:chktempleitem:add', '#', 'admin', '2024-10-08 13:41:40', 'admin', '2024-10-09 14:34:05', '','1');
INSERT INTO `sys_menu` VALUES (2101, '修改巡检模版', 2099, 2, '', '', NULL, 1, 0, 'F', '0', '0', 'system:chktempleitem:edit', '#', 'admin', '2024-10-08 13:43:03', 'admin', '2024-10-09 14:34:14', '','1');
INSERT INTO `sys_menu` VALUES (2102, '终端资产', 2000, 3, 'terminal', 'dbmgt/terminal/index', NULL, 1, 0, 'M', '0', '0', NULL, 'ri:terminal-box-line', 'admin', '2025-01-20 12:00:00', '', NULL, '', '1');
